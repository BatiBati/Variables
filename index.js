...
// 16.
// let number = 345;  // Үр дүнг шалгах тоо
// let firstDigit = Math.floor(number / 100);  // 100-ыг хувааж хамгийн эхний цифрийг авна
// console.log(firstDigit);  // 3

// let number = 345; // Үр дүнг шалгах тоо
// let firstDigit = "" + number; // Тоог стринг болгон хөрвүүлж
// firstDigit = firstDigit[0]; // Стрингийн хамгийн эхний тэмдэгтийг авна
// console.log(firstDigit); // 3
...
// const third = Number(prompt(`third number: `));
// const fourth = Number(prompt(`fourth number: `));
// const fifth = Number(prompt(`fifth number: `));
// if (
//   Number(isNaN(first)) ||
//   Number(isNaN(second)) ||
//   Number(isNaN(third)) ||
...
// Sample numbers : 2,5
// Output : 5
// const input1 = Number(9);
// const input2 = Number(7);
...
// } else if (character.length > 5 && character.length <= 10) {
...
//  b) If computerStatusCode is 200, print "Please stand by. Computer is rebooting.
//     " Else if computerStatusCode is 400, print "Success! Computer online." Else print "ALERT: Computer offline!"
// const computerStatusCode = 4030;
...
// const shuttleSpeed = 7999;
// if (shuttleSpeed.valueOf > 17500) {
...
//  d) Write If statement that takes number checks if the number is odd or even
...
// let temperature = 15;
// if (temperature < 0) {
//   console.log("Celsius is considered freezing");
// } else if (temperature >= 0 && temperature <= 30) {
//   console.log("Celsius is considered  normal");
// } else {
//   console.log("Celsius is considered  hot");
// }
...
//   console.log("35 is divisible by both 5 and 7");
// }
...
// if (sum % number === 0) {
//   console.log(`${sum} is a multiple of ${number}`);
// }
